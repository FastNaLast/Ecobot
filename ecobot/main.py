...
def sort(message):
    ...
    with open(f"./photo/{random.choice(plastik)}","rb") as f:
    ...
    with open(f"./photo/{random.choice(paper)}","rb") as f:
                bot.send_photo(message.chat.id, f)
    time.sleep(20)
    ...
    with open(f"./photo/{random.choice(steklo)}","rb") as f:
                bot.send_photo(message.chat.id, f)
    time.sleep(20)
    ...
    with open(f"./photo/{random.choice(metal)}","rb") as f:
                bot.send_photo(message.chat.id, f)
